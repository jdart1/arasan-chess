...
// Generated 09-Dec-2018 12:51:35 by tuner -n 175 -c 24 -R 25 /home/jdart/chess/data/epd/big5.epd
// Final objective value: 0.0680839
...
const int Params::PIN_MULTIPLIER_MID = 99;
...
const int Params::MINOR_ATTACK_BOOST = 44;
...
const int Params::TWO_ROOKS_ON_7TH_MID = 30;
...
const int Params::KING_ATTACK_SCALE[Params::KING_ATTACK_SCALE_SIZE] = {0, 0, 0, 0, 0, 1, 1, 2, 2, 3, 3, 4, 5, 5, 6, 7, 8, 8, 9, 10, 11, 12, 14, 15, 16, 17, 19, 20, 22, 23, 25, 27, 29, 31, 33, 35, 38, 40, 43, 46, 49, 52, 55, 58, 62, 65, 69, 73, 77, 82, 86, 91, 96, 101, 107, 112, 118, 124, 130, 137, 143, 150, 157, 165, 172, 180, 188, 196, 204, 212, 221, 230, 239, 248, 257, 266, 276, 285, 294, 304, 313, 323, 333, 342, 352, 361, 370, 380, 389, 398, 407, 416, 424, 433, 441, 449, 457, 465, 473, 480, 487, 494, 501, 508, 514, 520, 526, 532, 537, 542, 547, 552, 557, 561, 566, 570, 574, 577, 581, 584, 588, 591, 594, 596, 599, 602, 604, 606, 609, 611, 613, 615, 616, 618, 620, 621, 623, 624, 625, 626, 628, 629, 630, 631, 632, 633, 633, 634, 635, 636};
...
const int Params::POTENTIAL_PASSER[2][8] = {{0, 0, 0, 0, 0, 15, 96, 0}, {0, 0, 0, 0, 0, 18, 96, 0}};
const int Params::CONNECTED_PASSER[2][8] = {{0, 0, 4, 6, 23, 102, 200, 320}, {0, 0, 0, 0, 37, 90, 256, 320}};
const int Params::ADJACENT_PASSER[2][8] = {{0, 0, 0, 27, 11, 36, 96, 189}, {0, 0, 0, 10, 10, 26, 62, 67}};
const int Params::PP_OWN_PIECE_BLOCK[2][21] = {{-37, -24, -33, -8, -34, -11, -21, -26, -4, -26, -68, -19, 0, -16, 0, -40, -11, -41, -18, -55, 0}, {0, 0, 0, -3, -12, 0, 0, -10, -7, -18, -24, -7, -2, -11, -13, -17, -18, -30, -53, -41, -83}};
const int Params::PP_OPP_PIECE_BLOCK[2][21] = {{-60, -75, -54, -53, -47, -53, -58, -54, -26, -30, -32, -43, -8, 0, -3, -32, 0, -1, -67, -35, -83}, {-10, -4, 0, -7, -2, -1, -16, -7, -7, -5, -4, -28, -12, -9, 0, -51, -21, -13, -54, -37, -83}};
const int Params::DOUBLED_PAWNS[2][8] = {{-42, -2, -18, -11, -11, -18, -2, -42}, {-42, -19, -24, -20, -20, -24, -19, -42}};
const int Params::TRIPLED_PAWNS[2][8] = {{0, -27, -3, -18, -18, -3, -27, 0}, {-87, -72, -37, -39, -39, -37, -72, -87}};
const int Params::ISOLATED_PAWN[2][8] = {{0, 0, -17, -23, -23, -17, 0, 0}, {-5, -9, -11, -17, -17, -11, -9, -5}};

const int Params::KNIGHT_PST[2][64] = {{-81, -24, -7, -2, -2, -7, -24, -81, -21, -20, -10, 10, 10, -10, -20, -21, -40, -13, 6, 31, 31, 6, -13, -40, -13, 4, 26, 27, 27, 26, 4, -13, -24, -7, 25, 20, 20, 25, -7, -24, -49, -42, 3, 8, 8, 3, -42, -49, -100, -80, -25, -17, -17, -25, -80, -100, -128, -128, -128, -128, -128, -128, -128, -128}, {-76, -38, -26, -28, -28, -26, -38, -76, -34, -22, -21, -12, -12, -21, -22, -34, -44, -25, -15, 7, 7, -15, -25, -44, -20, -8, 11, 21, 21, 11, -8, -20, -31, -22, -1, 3, 3, -1, -22, -31, -51, -34, -15, -9, -9, -15, -34, -51, -71, -47, -44, -29, -29, -44, -47, -71, -128, -78, -76, -58, -58, -76, -78, -128}};
const int Params::BISHOP_PST[2][64] = {{18, 45, 33, 31, 31, 33, 45, 18, 37, 48, 40, 33, 33, 40, 48, 37, 15, 42, 41, 35, 35, 41, 42, 15, 4, 13, 23, 43, 43, 23, 13, 4, -32, -8, -1, 27, 27, -1, -8, -32, 7, -24, -38, -23, -23, -38, -24, 7, -28, -63, -59, -96, -96, -59, -63, -28, -21, -82, -128, -128, -128, -128, -82, -21}, {-9, 5, 11, 6, 6, 11, 5, -9, 11, 14, 10, 17, 17, 10, 14, 11, 4, 17, 23, 26, 26, 23, 17, 4, 4, 13, 26, 32, 32, 26, 13, 4, -16, -2, -1, 9, 9, -1, -2, -16, 4, -9, -9, -9, -9, -9, -9, 4, -5, -10, -17, -20, -20, -17, -10, -5, -0, -2, -7, -26, -26, -7, -2, -0}};
const int Params::ROOK_PST[2][64] = {{-46, -32, -27, -23, -23, -27, -32, -46, -59, -32, -28, -23, -23, -28, -32, -59, -57, -32, -33, -31, -31, -33, -32, -57, -55, -40, -37, -29, -29, -37, -40, -55, -33, -25, -12, -10, -10, -12, -25, -33, -21, 5, -5, 7, 7, -5, 5, -21, -19, -25, 0, 3, 3, 0, -25, -19, -12, -6, -97, -62, -62, -97, -6, -12}, {-6, -7, 1, -4, -4, 1, -7, -6, -17, -10, -3, -3, -3, -3, -10, -17, -13, -7, -0, -3, -3, -0, -7, -13, -1, 7, 13, 8, 8, 13, 7, -1, 14, 16, 21, 18, 18, 21, 16, 14, 19, 23, 28, 27, 27, 28, 23, 19, 7, 11, 16, 18, 18, 16, 11, 7, 29, 30, 29, 25, 25, 29, 30, 29}};
const int Params::QUEEN_PST[2][64] = {{29, 31, 27, 38, 38, 27, 31, 29, 23, 41, 43, 44, 44, 43, 41, 23, 23, 37, 41, 31, 31, 41, 37, 23, 35, 39, 41, 42, 42, 41, 39, 35, 38, 41, 45, 53, 53, 45, 41, 38, 28, 46, 52, 48, 48, 52, 46, 28, 30, 12, 35, 38, 38, 35, 12, 30, 43, 43, 18, 5, 5, 18, 43, 43}, {-46, -61, -45, -29, -29, -45, -61, -46, -34, -30, -23, -6, -6, -23, -30, -34, -23, 6, 17, 8, 8, 17, 6, -23, 9, 29, 35, 37, 37, 35, 29, 9, 16, 48, 54, 68, 68, 54, 48, 16, 10, 45, 64, 81, 81, 64, 45, 10, 27, 47, 74, 85, 85, 74, 47, 27, 4, 20, 19, 22, 22, 19, 20, 4}};
const int Params::KING_PST[2][64] = {{30, 47, -14, 9, 9, -14, 47, 30, 75, 75, 22, 47, 47, 22, 75, 75, -5, 16, -60, -120, -120, -60, 16, -5, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -128, -100, -128, -128, -128, -128, -100, -128, 31, -44, -128, -128, -128, -128, -44, 31, -128, -106, 128, -128, -128, 128, -106, -128}, {-60, -61, -66, -70, -70, -66, -61, -60, -49, -56, -63, -63, -63, -63, -56, -49, -58, -62, -59, -58, -58, -59, -62, -58, -56, -53, -48, -45, -45, -48, -53, -56, -42, -37, -30, -29, -29, -30, -37, -42, -36, -25, -24, -24, -24, -24, -25, -36, -45, -35, -31, -33, -33, -31, -35, -45, -74, -49, -48, -46, -46, -48, -49, -74}};
...
const int Params::QUEEN_MOBILITY[2][24] = {{-59, 0, 13, 22, 29, 36, 43, 48, 54, 58, 60, 61, 64, 65, 68, 71, 70, 83, 96, 96, 96, 96, 96, 96}, {-96, -96, -78, -38, 14, 25, 41, 48, 55, 60, 65, 71, 77, 80, 84, 83, 88, 85, 84, 87, 90, 92, 83, 78}};
...
const int Params::PAWN_STORM[2][2][4] = {{{0, -14, -20, -3},{0, -90, -36, -12}},
{{-27, -26, 0, 0},{-120, -31, -2, 0}}};
