...
const int Params::RB_ADJUST[6] = {328, -50, 602, 158, 140, 318};
const int Params::RBN_ADJUST[6] = {500, -150, 200, -9, -236, -250};
const int Params::QR_ADJUST[5] = {408, 917, 425, -178, -750};
const int Params::KN_VS_PAWN_ADJUST[3] = {0, -2264, -1211};
const int Params::CASTLING[6] = {100, -214, -195, 0, 65, -111};
const int Params::KING_COVER[6][4] = {{95, 189, 98, 89},
{45, 91, 47, 43},
{-30, -59, -31, -28},
{-6, -13, -7, -6},
{-68, -136, -70, -64},
...
const int Params::PIN_MULTIPLIER_MID = 494;
const int Params::PIN_MULTIPLIER_END = 534;
const int Params::KRMINOR_VS_R = 0;
const int Params::KRMINOR_VS_R_NO_PAWNS = -1348;
const int Params::KQMINOR_VS_Q = 0;
const int Params::KQMINOR_VS_Q_NO_PAWNS = -1286;
const int Params::MINOR_FOR_PAWNS = 228;
const int Params::ENDGAME_PAWN_ADVANTAGE = 250;
const int Params::PAWN_ENDGAME1 = 313;
const int Params::PAWN_ENDGAME2 = 73;
...
const int Params::PAWN_THREAT_ON_PIECE_MID = 16;
const int Params::PAWN_THREAT_ON_PIECE_END = 89;
const int Params::PIECE_THREAT_MM_MID = 177;
const int Params::PIECE_THREAT_MR_MID = 421;
const int Params::PIECE_THREAT_MQ_MID = 361;
const int Params::PIECE_THREAT_MM_END = 248;
const int Params::PIECE_THREAT_MR_END = 482;
const int Params::PIECE_THREAT_MQ_END = 750;
const int Params::MINOR_PAWN_THREAT_MID = 72;
const int Params::MINOR_PAWN_THREAT_END = 186;
const int Params::PIECE_THREAT_RM_MID = 151;
const int Params::PIECE_THREAT_RR_MID = 128;
const int Params::PIECE_THREAT_RQ_MID = 546;
const int Params::PIECE_THREAT_RM_END = 128;
const int Params::PIECE_THREAT_RR_END = 108;
const int Params::PIECE_THREAT_RQ_END = 750;
const int Params::ROOK_PAWN_THREAT_MID = 110;
const int Params::ROOK_PAWN_THREAT_END = 226;
const int Params::ENDGAME_KING_THREAT = 282;
const int Params::BISHOP_TRAPPED = -1470;
const int Params::BISHOP_PAIR_MID = 249;
const int Params::BISHOP_PAIR_END = 477;
const int Params::BISHOP_PAWN_PLACEMENT_END = -33;
const int Params::BAD_BISHOP_MID = -41;
const int Params::BAD_BISHOP_END = -39;
const int Params::CENTER_PAWN_BLOCK = -227;
const int Params::OUTSIDE_PASSER_MID = 110;
const int Params::OUTSIDE_PASSER_END = 234;
const int Params::WEAK_PAWN_MID = -19;
const int Params::WEAK_PAWN_END = 0;
const int Params::WEAK_ON_OPEN_FILE_MID = -175;
const int Params::WEAK_ON_OPEN_FILE_END = -171;
const int Params::SPACE = 30;
const int Params::PAWN_CENTER_SCORE_MID = 0;
const int Params::ROOK_ON_7TH_MID = 0;
const int Params::ROOK_ON_7TH_END = 189;
const int Params::TWO_ROOKS_ON_7TH_MID = 203;
const int Params::TWO_ROOKS_ON_7TH_END = 650;
const int Params::ROOK_ON_OPEN_FILE_MID = 169;
const int Params::ROOK_ON_OPEN_FILE_END = 115;
const int Params::ROOK_BEHIND_PP_MID = 0;
const int Params::ROOK_BEHIND_PP_END = 106;
const int Params::QUEEN_OUT = -68;
const int Params::PAWN_SIDE_BONUS = 128;
const int Params::KING_OWN_PAWN_DISTANCE = 73;
const int Params::KING_OPP_PAWN_DISTANCE = 17;
const int Params::QUEENING_SQUARE_CONTROL_MID = 564;
const int Params::QUEENING_SQUARE_CONTROL_END = 420;
const int Params::QUEENING_SQUARE_OPP_CONTROL_MID = -210;
const int Params::QUEENING_SQUARE_OPP_CONTROL_END = -456;
const int Params::WRONG_COLOR_BISHOP = 0;
const int Params::SIDE_PROTECTED_PAWN = -41;
const int Params::KING_OPP_PASSER_DISTANCE[6] = {0, 19, 175, 401, 648, 750};
const int Params::KING_POSITION_LOW_MATERIAL[3] ={300, 225, 156};
const int Params::KING_ATTACK_SCALE[Params::KING_ATTACK_SCALE_SIZE] = {-15, -13, -11, -9, -6, -3, -1, 3, 6, 9, 13, 17, 21, 25, 30, 35, 40, 46, 52, 58, 65, 72, 80, 88, 97, 106, 116, 126, 137, 148, 160, 173, 187, 202, 217, 233, 251, 269, 288, 308, 330, 352, 376, 401, 428, 455, 485, 515, 548, 581, 617, 654, 693, 733, 776, 820, 866, 914, 964, 1015, 1069, 1125, 1182, 1241, 1302, 1365, 1429, 1495, 1563, 1632, 1703, 1775, 1848, 1923, 1998, 2074, 2151, 2228, 2305, 2383, 2461, 2539, 2617, 2694, 2771, 2847, 2923, 2997, 3070, 3142, 3213, 3282, 3350, 3417, 3481, 3544, 3605, 3665, 3722, 3778, 3832, 3884, 3934, 3982, 4028, 4072, 4115, 4156, 4195, 4232, 4268, 4302, 4334, 4365, 4394, 4422, 4449, 4474, 4498, 4521, 4542, 4563, 4582, 4600, 4618, 4634, 4649, 4664, 4678, 4691, 4703, 4715, 4726, 4736, 4746, 4755, 4764, 4772, 4780, 4787, 4794, 4800, 4806, 4812, 4817, 4822, 4827, 4831, 4835, 4839};
const int Params::TRADE_DOWN[8] = {355, 269, 183, 97, 11, 0, 0, 0};
const int Params::PASSED_PAWN[2][8] = {{0, 0, 0, 0, 0, 165, 700, 763}, {0, 0, 0, 0, 117, 517, 1198, 1750}};
const int Params::PASSED_PAWN_FILE_ADJUST[8] = {79, 82, 79, 76, 76, 79, 82, 79};
const int Params::POTENTIAL_PASSER[2][8] = {{0, 0, 0, 0, 0, 21, 750, 0}, {0, 0, 0, 0, 0, 136, 750, 0}};
const int Params::CONNECTED_PASSER[2][8] = {{0, 0, 0, 0, 30, 687, 1250, 1750}, {0, 0, 0, 0, 381, 692, 1250, 1750}};
const int Params::ADJACENT_PASSER[2][8] = {{0, 0, 0, 50, 70, 160, 693, 1316}, {0, 0, 0, 50, 127, 250, 473, 740}};
const int Params::PP_OWN_PIECE_BLOCK[2][21] = {{-333, -298, -331, -189, -329, 0, -186, -245, -41, -325, 0, -286, -49, -264, -86, -280, -112, -333, -72, -333, 0}, {-20, 0, -28, -93, -152, -125, -44, -119, -133, -217, -219, -83, -47, -52, -187, -184, -129, -309, -333, -333, -333}};
const int Params::PP_OPP_PIECE_BLOCK[2][21] = {{-333, -333, -333, -333, -333, -333, -333, -333, -329, -333, -333, -333, -136, -20, -58, -173, 0, 0, -333, -156, -333}, {-133, -105, -44, -104, -127, -62, -159, -50, -108, -67, -66, -194, -38, -25, -9, -326, -171, -141, -333, -333, -333}};
const int Params::DOUBLED_PAWNS[2][8] = {{-365, -6, -177, -162, -162, -177, -6, -365}, {-341, -154, -230, -146, -146, -230, -154, -341}};
const int Params::TRIPLED_PAWNS[2][8] = {{0, -404, -107, 0, 0, -107, -404, 0}, {0, -370, -97, -388, -388, -97, -370, 0}};
const int Params::ISOLATED_PAWN[2][8] = {{0, 0, -78, -91, -91, -78, 0, 0}, {-35, -63, -73, -131, -131, -73, -63, -35}};

const int Params::KNIGHT_PST[2][64] = {{-580, -278, -137, -111, -111, -137, -278, -580, -142, -236, -201, -23, -23, -201, -236, -142, -299, -133, -28, 59, 59, -28, -133, -299, -182, -140, 25, 20, 20, 25, -140, -182, -101, -127, 56, -64, -64, 56, -127, -101, -233, -581, -496, -170, -170, -496, -581, -233, -535, -403, -4, 7, 7, -4, -403, -535, -1000, -1000, -1000, -1000, -1000, -1000, -1000, -1000}, {-358, -293, -227, -187, -187, -227, -293, -358, -232, -204, -118, -99, -99, -118, -204, -232, -272, -186, -126, 17, 17, -126, -186, -272, -133, -105, 70, 121, 121, 70, -105, -133, -128, -139, 10, -2, -2, 10, -139, -128, -219, -482, -365, -254, -254, -365, -482, -219, -429, -213, -201, -160, -160, -201, -213, -429, -1000, -442, -477, -370, -370, -477, -442, -1000}};
