...
class Scoring
{
    ...
    static const int NUM_PARAMS = 118;
    ...
    enum {
      ...
      KNIGHT_OUTPOST_RANK4_CENTRALITY,
      KNIGHT_OUTPOST_RANK4_CENTRALITY_POW,
      KNIGHT_OUTPOST_RANK5,
      KNIGHT_OUTPOST_RANK5_CENTRALITY,
      KNIGHT_OUTPOST_RANK5_CENTRALITY_POW,
      KNIGHT_OUTPOST_RANK6,
      KNIGHT_OUTPOST_RANK6_CENTRALITY,
      KNIGHT_OUTPOST_RANK6_CENTRALITY_POW,
      KNIGHT_OUTPOST_RANK7,
      KNIGHT_OUTPOST_RANK7_CENTRALITY,
      KNIGHT_OUTPOST_RANK7_CENTRALITY_POW,
      KNIGHT_OUTPOST_RANK8,
      KNIGHT_OUTPOST_RANK8_CENTRALITY,
      KNIGHT_OUTPOST_RANK8_CENTRALITY_POW,
      BISHOP_OUTPOST_RANK4,
      BISHOP_OUTPOST_RANK4_CENTRALITY,
      BISHOP_OUTPOST_RANK4_CENTRALITY_POW,
      BISHOP_OUTPOST_RANK5,
      BISHOP_OUTPOST_RANK5_CENTRALITY,
      BISHOP_OUTPOST_RANK5_CENTRALITY_POW,
      BISHOP_OUTPOST_RANK6,
      BISHOP_OUTPOST_RANK6_CENTRALITY,
      BISHOP_OUTPOST_RANK6_CENTRALITY_POW,
      BISHOP_OUTPOST_RANK7,
      BISHOP_OUTPOST_RANK7_CENTRALITY,
      BISHOP_OUTPOST_RANK7_CENTRALITY_POW,
      BISHOP_OUTPOST_RANK8,
      BISHOP_OUTPOST_RANK8_CENTRALITY,
      BISHOP_OUTPOST_RANK8_CENTRALITY_POW,
      KNIGHT_MOBILITY0,
