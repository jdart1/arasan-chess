...
class Tune {
 ...
 public:
  ...
  enum {
    ...
    KNIGHT_PST_MIDGAME = 140,
    KNIGHT_PST_ENDGAME = 172,
    BISHOP_PST_MIDGAME = 204,
    BISHOP_PST_ENDGAME = 236,
    ROOK_PST_MIDGAME = 268,
    ROOK_PST_ENDGAME = 300,
    QUEEN_PST_MIDGAME = 332,
    QUEEN_PST_ENDGAME = 364,
    KING_PST_MIDGAME = 396,
    KING_PST_ENDGAME = 428,
    KNIGHT_MOBILITY = 460,
    BISHOP_MOBILITY = 469,
    ROOK_MOBILITY_MIDGAME = 484,
    ROOK_MOBILITY_ENDGAME = 499,
    QUEEN_MOBILITY_MIDGAME = 514,
    QUEEN_MOBILITY_ENDGAME = 543,
    KING_MOBILITY_ENDGAME = 572,
    KNIGHT_OUTPOST = 581,
    BISHOP_OUTPOST = 629
  };
  ...
  static const int NUM_MISC_PARAMS = 140;
