...
Tune::Tune() 
{
    ...
    static Tune::TuneParam initial_params[Tune::NUM_MISC_PARAMS] = {
        ...
        Tune::TuneParam(Tune::KING_POSITION_LOW_MATERIAL0,"king_position_low_material0",180,128,300,Tune::TuneParam::Endgame,0),
        Tune::TuneParam(Tune::KING_POSITION_LOW_MATERIAL1,"king_position_low_material1",160,128,300,Tune::TuneParam::Endgame,0),
