...
void Tune::applyParams() const
{
   ...
   Params::KING_ATTACK_SCALE_MAX = (*this)[Tune::KING_ATTACK_SCALE_MAX].current;
   Params::KING_ATTACK_SCALE_INFLECT = (*this)[Tune::KING_ATTACK_SCALE_INFLECT].current;
   Params::KING_ATTACK_SCALE_FACTOR = (*this)[Tune::KING_ATTACK_SCALE_FACTOR].current;
   Params::KING_ATTACK_SCALE_BIAS = (*this)[Tune::KING_ATTACK_SCALE_BIAS].current;

   // compute king cover scores
   for (i = 0; i < 6; i++) {
      for (int k = 0; k < 4; k++) {
         Params::KING_COVER[i][k] =
            (*this)[Tune::KING_COVER1+i].current*(*this)[Tune::KING_COVER_FILE_FACTOR0+k].current/64;
      }
   }
   Params::KING_COVER_BASE = (*this)[KING_COVER_BASE].current;
   Params::KING_DISTANCE_BASIS = (*this)[KING_DISTANCE_BASIS].current;
   Params::KING_DISTANCE_MULT = (*this)[KING_DISTANCE_MULT].current;
   Params::PIN_MULTIPLIER_MID = (*this)[PIN_MULTIPLIER_MID].current;
   Params::PIN_MULTIPLIER_END = (*this)[PIN_MULTIPLIER_END].current;
   Params::KRMINOR_VS_R = (*this)[KRMINOR_VS_R].current;
   Params::KRMINOR_VS_R_NO_PAWNS = (*this)[KRMINOR_VS_R_NO_PAWNS].current;
   Params::KQMINOR_VS_Q = (*this)[KQMINOR_VS_Q].current;
   Params::KQMINOR_VS_Q_NO_PAWNS = (*this)[KQMINOR_VS_Q_NO_PAWNS].current;
   Params::MINOR_FOR_PAWNS = (*this)[MINOR_FOR_PAWNS].current;
   Params::ENDGAME_PAWN_ADVANTAGE = (*this)[ENDGAME_PAWN_ADVANTAGE].current;
   Params::PAWN_ENDGAME1 = (*this)[PAWN_ENDGAME1].current;
   Params::PAWN_ENDGAME2 = (*this)[PAWN_ENDGAME2].current;
   Params::PAWN_ATTACK_FACTOR1 = (*this)[PAWN_ATTACK_FACTOR1].current;
   Params::PAWN_ATTACK_FACTOR2 = (*this)[PAWN_ATTACK_FACTOR2].current;
   Params::MINOR_ATTACK_FACTOR = (*this)[MINOR_ATTACK_FACTOR].current;
   Params::MINOR_ATTACK_BOOST = (*this)[MINOR_ATTACK_BOOST].current;
   Params::ROOK_ATTACK_FACTOR = (*this)[ROOK_ATTACK_FACTOR].current;
   Params::ROOK_ATTACK_BOOST = (*this)[ROOK_ATTACK_BOOST].current;
   Params::ROOK_ATTACK_BOOST2 = (*this)[ROOK_ATTACK_BOOST2].current;
   Params::KING_ATTACK_COVER_BOOST_BASE = (*this)[KING_ATTACK_COVER_BOOST_BASE].current;
   Params::KING_ATTACK_COVER_BOOST_SLOPE = (*this)[KING_ATTACK_COVER_BOOST_SLOPE].current;
   Params::QUEEN_ATTACK_FACTOR = (*this)[QUEEN_ATTACK_FACTOR].current;
   Params::QUEEN_ATTACK_BOOST = (*this)[QUEEN_ATTACK_BOOST].current;
   Params::QUEEN_ATTACK_BOOST2 = (*this)[QUEEN_ATTACK_BOOST2].current;
   Params::PAWN_THREAT_ON_PIECE_MID = (*this)[PAWN_THREAT_ON_PIECE_MID].current;
   Params::PAWN_THREAT_ON_PIECE_END = (*this)[PAWN_THREAT_ON_PIECE_END].current;
   Params::PIECE_THREAT_MM_MID = (*this)[PIECE_THREAT_MM_MID].current;
   Params::PIECE_THREAT_MR_MID = (*this)[PIECE_THREAT_MR_MID].current;
   Params::PIECE_THREAT_MQ_MID = (*this)[PIECE_THREAT_MQ_MID].current;
   Params::PIECE_THREAT_MM_END = (*this)[PIECE_THREAT_MM_END].current;
   Params::PIECE_THREAT_MR_END = (*this)[PIECE_THREAT_MR_END].current;
   Params::PIECE_THREAT_MQ_END = (*this)[PIECE_THREAT_MQ_END].current;
   Params::MINOR_PAWN_THREAT_MID = (*this)[MINOR_PAWN_THREAT_MID].current;
   Params::MINOR_PAWN_THREAT_END = (*this)[MINOR_PAWN_THREAT_END].current;
   Params::PIECE_THREAT_RM_MID = (*this)[PIECE_THREAT_RM_MID].current;
   Params::PIECE_THREAT_RR_MID = (*this)[PIECE_THREAT_RR_MID].current;
   Params::PIECE_THREAT_RQ_MID = (*this)[PIECE_THREAT_RQ_MID].current;
   Params::PIECE_THREAT_RM_END = (*this)[PIECE_THREAT_RM_END].current;
   Params::PIECE_THREAT_RR_END = (*this)[PIECE_THREAT_RR_END].current;
   Params::PIECE_THREAT_RQ_END = (*this)[PIECE_THREAT_RQ_END].current;
   Params::ROOK_PAWN_THREAT_MID = (*this)[ROOK_PAWN_THREAT_MID].current;
   Params::ROOK_PAWN_THREAT_END = (*this)[ROOK_PAWN_THREAT_END].current;
   Params::ENDGAME_KING_THREAT = (*this)[ENDGAME_KING_THREAT].current;
   Params::BISHOP_TRAPPED = (*this)[BISHOP_TRAPPED].current;
   Params::BISHOP_PAIR_MID = (*this)[BISHOP_PAIR_MID].current;
   Params::BISHOP_PAIR_END = (*this)[BISHOP_PAIR_END].current;
   Params::BISHOP_PAWN_PLACEMENT_END = (*this)[BISHOP_PAWN_PLACEMENT_END].current;
   Params::BAD_BISHOP_MID = (*this)[BAD_BISHOP_MID].current;
   Params::BAD_BISHOP_END = (*this)[BAD_BISHOP_END].current;
   Params::CENTER_PAWN_BLOCK = (*this)[CENTER_PAWN_BLOCK].current;
   Params::OUTSIDE_PASSER_MID = (*this)[OUTSIDE_PASSER_MID].current;
   Params::OUTSIDE_PASSER_END = (*this)[OUTSIDE_PASSER_END].current;
   Params::WEAK_PAWN_MID = (*this)[WEAK_PAWN_MID].current;
   Params::WEAK_PAWN_END = (*this)[WEAK_PAWN_END].current;
   Params::WEAK_ON_OPEN_FILE_MID = (*this)[WEAK_ON_OPEN_FILE_MID].current;
   Params::WEAK_ON_OPEN_FILE_END = (*this)[WEAK_ON_OPEN_FILE_END].current;
   Params::SPACE = (*this)[SPACE].current;
   Params::PAWN_CENTER_SCORE_MID = (*this)[PAWN_CENTER_SCORE_MID].current;
   Params::ROOK_ON_7TH_MID = (*this)[ROOK_ON_7TH_MID].current;
   Params::ROOK_ON_7TH_END = (*this)[ROOK_ON_7TH_END].current;
   Params::TWO_ROOKS_ON_7TH_MID = (*this)[TWO_ROOKS_ON_7TH_MID].current;
   Params::TWO_ROOKS_ON_7TH_END = (*this)[TWO_ROOKS_ON_7TH_END].current;
   Params::ROOK_ON_OPEN_FILE_MID = (*this)[ROOK_ON_OPEN_FILE_MID].current;
   Params::ROOK_ON_OPEN_FILE_END = (*this)[ROOK_ON_OPEN_FILE_END].current;
   Params::ROOK_BEHIND_PP_MID = (*this)[ROOK_BEHIND_PP_MID].current;
   Params::ROOK_BEHIND_PP_END = (*this)[ROOK_BEHIND_PP_END].current;
   Params::QUEEN_OUT = (*this)[QUEEN_OUT].current;
   Params::PAWN_SIDE_BONUS = (*this)[PAWN_SIDE_BONUS].current;
   Params::KING_OWN_PAWN_DISTANCE = (*this)[KING_OWN_PAWN_DISTANCE].current;
   Params::KING_OPP_PAWN_DISTANCE = (*this)[KING_OPP_PAWN_DISTANCE].current;
   Params::QUEENING_SQUARE_CONTROL_MID = (*this)[QUEENING_SQUARE_CONTROL_MID].current;
   Params::QUEENING_SQUARE_CONTROL_END = (*this)[QUEENING_SQUARE_CONTROL_END].current;
   Params::QUEENING_SQUARE_OPP_CONTROL_MID = (*this)[QUEENING_SQUARE_OPP_CONTROL_MID].current;
   Params::QUEENING_SQUARE_OPP_CONTROL_END = (*this)[QUEENING_SQUARE_OPP_CONTROL_END].current;
   Params::WRONG_COLOR_BISHOP = (*this)[WRONG_COLOR_BISHOP].current;
   Params::SIDE_PROTECTED_PAWN = (*this)[SIDE_PROTECTED_PAWN].current;
   for (int i = 0; i < 6; i++) {
